    ...
    <section id="contact" className="relative flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 w-full px-4 py-10">
        <div className="max-w-2xl lg:max-w-3xl mx-auto">
          <div className="rounded-3xl p-6 md:p-12 shadow-2xl" style={{ backgroundColor: '#1D212B' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <input
                  ...
                  className="w-full px-5 py-3 rounded-xl focus:ring-2 focus:ring-white/20 focus:outline-none transition-all duration-200 font-light text-white placeholder-white/40"
              ...
              <button
                ...
                className="w-full py-3 rounded-full font-medium tracking-wide text-lg transition-all duration-200 hover:scale-[1.02] active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed bg-white"
                style={{ color: '#1D212B' }}
              >
              ...
              {status === 'success' && (
                <div className="rounded-xl p-4 text-center border border-white/20">
